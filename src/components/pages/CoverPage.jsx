  ...
  return (
    <Page dark id="cover">
      <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[520px]">
        <div className="bg-zinc-950 relative overflow-hidden flex flex-col justify-between p-8 md:p-12 border-r-2 border-orange-600 z-10">
          <GridBackground size="sm" />

          <div className="relative z-10">
            <div className="inline-block bg-orange-600 text-zinc-950 font-bebas px-3 py-1 text-xl tracking-widest mb-4">
              {t.cover.dossier}
            </div>
            <h1 className="font-bebas text-[clamp(60px,8vw,120px)] leading-[0.85] text-white tracking-wide mb-2 uppercase">
              {ATHLETE.name.split('\n').map((line, i) => (
          ...
          <div className="relative z-10 border-t border-zinc-800 pt-6 grid grid-cols-2 gap-y-4 gap-x-4">
            <div>
